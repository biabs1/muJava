...
public class ComposedStatementVisitor extends ParseTreeVisitor {

    private ArrayList<ParseTree> children = new ArrayList<>();

    public ArrayList<ParseTree> getChildren() {
        return this.children;
    }

    protected void addChild(ParseTree p) throws ParseTreeException {
        children.add(p);
    }
    ...
    public void visit(AssignmentExpression var1) throws ParseTreeException {
        ...
        var1.getLeft().accept(visitor);
        var1.getRight().accept(visitor);
